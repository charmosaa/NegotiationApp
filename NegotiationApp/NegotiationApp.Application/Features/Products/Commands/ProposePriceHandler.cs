...
{
    public class ProposePriceHandler : IRequestHandler<ProposePriceCommand, NegotiationDto>
    {
        private readonly INegotiationRepository _negotiationRepository;

        public ProposePriceHandler(INegotiationRepository negotiationRepository)
        {
            _negotiationRepository = negotiationRepository;
        }

        public async Task<NegotiationDto> Handle(ProposePriceCommand request, CancellationToken cancellationToken)
        {
            ...
            negotiation.ProposePrice(request.ProposedPrice);
